...
SimpleForm.setup do |config| # rubocop:disable BlockLength
  ...
  config.wrappers :horizontal_file_input, tag: 'div', class: 'form-group' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :horizontal_radio_and_checkboxes, tag: 'div', class: 'form-group' do |b|
    b.use :html5
    b.optional :readonly
